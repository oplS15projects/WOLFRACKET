                    ...
                    (body   (div ((class "header"))
                                ...
                                (div ((class "content"))
                                     ...
                                     (form (select ((id "method"))
                                                   (option ((value "add")) "add (2)")
                                                   (option ((value "subtract")) "subtract (2)")
                                                   (option ((value "exponent")) "exponent (2)")
                                                   (option ((value "divide")) "divide (2)")
                                                   (option ((value "prime")) "prime (1)")
                                                   (option ((value "logarithm")) "logarithm (1)")
                                                   (option ((value "factorial")) "factorial (1)")
                                                   (option ((value "sin")) "sin (1)")
                                                   (option ((value "cos")) "cos (1)")
                                                   (option ((value "sqrt")) "sqrt (1)"))
